...
.bar{flex:1;height:8px;background:#ece7da;border-radius:6px;overflow:hidden}
.bar i{display:block;height:100%;width:92%;background:var(--green);border-radius:6px}
